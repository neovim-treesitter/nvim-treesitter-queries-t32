...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-t32/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-t32/actions/workflows/validate.yml)

Neovim tree-sitter queries for **t32**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-t32",
...
- [ ] Changes are scoped to `t32` — do not include files for other languages
